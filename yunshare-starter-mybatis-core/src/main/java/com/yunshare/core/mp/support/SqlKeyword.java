        ...
        query.forEach((k, v) -> {
            ...
            if (k.endsWith(EQUAL)) {
                ...
                if (v instanceof  String){
                    qw.in(getColumn(k, IN),Func.toStrList((String) v));
                }else {
                    qw.in(getColumn(k, IN), (Collection<?>)v);
                }
            }else if (k.endsWith(NOT_IN)) {
                if (v instanceof  String){
                    qw.notIn(getColumn(k, NOT_IN),Func.toStrList((String) v));
                }else {
                    qw.notIn(getColumn(k, NOT_IN), (Collection<?>)v);
                }
            } else {
