...
import com.yunshare.core.tool.support.StrSpliter;
...
public class StringUtil extends org.springframework.util.StringUtils {
	 ...
	 * <p>
	 * use: format("my name is ${name}, and i like ${like}!", {"name":"lzx@yuyuda.com", "like": "Java"})
	 *
	 ...
	 * 同 log 格式的 format 规则
	 * <p>
	 * use: format("my name is {}, and i like {}!", "lzx@yuyuda.com", "Java")
	 *
	 * @param message   需要转换的字符串
