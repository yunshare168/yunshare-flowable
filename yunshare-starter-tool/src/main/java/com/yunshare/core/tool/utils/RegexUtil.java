...
public class RegexUtil {
     ...
     * 帕斯卡命名不包含数字
     */
    public static final String PASCAL_CASE = "^[A-Z][a-z]+(?:[A-Z][a-z]+)*$";

    /**
     * 帕斯卡命名包含数字
     */
    public static final String PASCAL_CASE_NUM = "^[A-Z][a-z0-9]+(?:[A-Z][a-z0-9]+)*$";

    /**
     * 驼峰命名
     */
    public static final String CAMEL = "^[a-z][a-z0-9]+(?:[A-Z][a-z0-9]+)*$";

    /**
     * java 包名
     */
    public static final String JAVA_PACKAGE = "^([a-zA-Z_$][a-zA-Z\\d_$]*\\.)*[a-zA-Z_$][a-zA-Z\\d_$]*$";
