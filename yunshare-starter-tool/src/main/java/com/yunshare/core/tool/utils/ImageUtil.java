...
import com.yunshare.core.tool.support.IMultiOutputStream;
import com.yunshare.core.tool.support.ImagePosition;
...
public final class ImageUtil {
    ...
    public static void zoomScale(BufferedImage src, OutputStream output, String type, double scale, boolean flag) {
        try {
            ...
            Image image = src.getScaledInstance(Func.toInt(width), Func.toInt(height), Image.SCALE_DEFAULT);
            BufferedImage tag = new BufferedImage(Func.toInt(width), Func.toInt(height), BufferedImage.TYPE_INT_RGB);
    ...
    public static void zoomFixed(BufferedImage src, OutputStream output, String type, int height, int width, boolean bb, Color fillColor) {
        try {
            ...
            if (src.getHeight() > src.getWidth()) {
                ratio = (double) height / (double) src.getHeight();
            } else {
                ratio = (double) width / (double) src.getWidth();
            }
